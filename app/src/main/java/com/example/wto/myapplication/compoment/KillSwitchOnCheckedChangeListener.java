 ...
 *
 */
public class KillSwitchOnCheckedChangeListener implements CompoundButton.OnCheckedChangeListener
{
    ...
    public KillSwitchOnCheckedChangeListener(Context context, Passage passage)
    {
